...
read_blksize_seconds_df = pd.read_csv('./combined_results/fixed_data_results.csv', usecols = ['start.test_start.blksize','end.sum_received.seconds','start.test_start.bytes','end.sum_received.bytes','end.sum_received.bits_per_second'] )
read_blksize_seconds_df.to_csv('./combined_results/simplified_fixed_data_results.csv',sep=',')

read_blksize_seconds_df2 = pd.read_csv('./combined_results/fixed_MTU_results.csv', usecols = ['start.test_start.blksize','end.sum_received.seconds','start.test_start.bytes','end.sum_received.bytes','end.sum_received.bits_per_second'] )
read_blksize_seconds_df2.to_csv('./combined_results/simplified_fixed_MTU_results.csv',sep=',')

read_blksize_seconds_df3 = pd.read_csv('./combined_results/fixed_MTU_Jumbo_results.csv', usecols = ['start.test_start.blksize','end.sum_received.seconds','start.test_start.bytes','end.sum_received.bytes','end.sum_received.bits_per_second'] )
